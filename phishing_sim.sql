CREATE DATABASE IF NOT EXISTS `phishing_sim`defaultdbdefaultdbdefaultdbdefaultdbdefaultdbdefaultdbdefaultdbdefaultdbdefaultdb DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `phishing_sim`;
