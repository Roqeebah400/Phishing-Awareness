...
<nav class="navbar navbar-dark bg-dark">
  ...
  <div class="container">
    ...
    <div>
      ...
      <a href="detector.php" class="btn btn-primary btn-sm">
        Scan Email
      </a>
            ...
            <?php foreach ($scans as $i => $s): ?>
              ...
              <tr>
                ...
                <td>
                  ...
                  <span class="badge bg-<?=
                    str_contains($s['verdict'], 'High')
                    ? 'danger'
                    : (
                        str_contains($s['verdict'], 'Medium')
                        ? 'warning'
                        : 'success'
                    )
                  ?>">

                    <?= htmlspecialchars($s['verdict']) ?>
                ...
                <td>
                  <strong>
                    <?= htmlspecialchars($s['risk_score']) ?>/100
                  </strong>
                </td>

                <td>
                  <?= htmlspecialchars($s['flags_count']) ?>
                </td>
